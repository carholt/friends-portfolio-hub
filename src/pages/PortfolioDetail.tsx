      ...
      <div className="space-y-4">
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2"><Button variant="outline" onClick={() => exportToCSV(data.portfolio.name, data.holdings)}>Export CSV</Button><Button variant="outline" onClick={() => exportToJSON(data.portfolio, data.holdings)}>Export JSON</Button><Button onClick={() => setShowImport(true)}>Import holdings</Button><Button variant="secondary" onClick={() => setShowTxImport(true)}>Import transactions (Nordea)</Button>{isOwner && <Button variant="outline" disabled={refreshingClassifications} onClick={async () => {
